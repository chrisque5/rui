...
describe('E2E scenario for Forward backdate ', () => {
  it('FWD_C13105 FWD USD CNH 1M XOFF (New)', () => {
    ...
    deal.placeForwardOrderDetails(instrument.CURRENCY_A, instrument.CURRENCY_S, '', instrument.TENOR_E, '6.984', '62', '10', '', '10');
    ...
    log.log(`Test Case Number : FWD_C13105 and Deal ID : ${dealId}`);
    e2e.saveDealTestMap(1, `Test Case Number : FWD_C13105 and Deal ID : ${dealId}`);
    sharedStore.setValueToStore('C13105', dealId);
    e2e.saveDealIdWithTest(`${dealId}@@complete:new:leg1`, `FWD_C13105@@FWD=>fwd=>backdate:FWD_USD_CNH_1M_${instrument.VENUE_B}_NEW`);
