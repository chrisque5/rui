...
describe('E2E scenario for Forward Dealt CCY', () => {
  it('FWD_06_C12499 FWD SGD USD 1M XOFF (New)', () => {
    ...
    log.log(`Test Case Number : FWD_06_C12499 and Deal ID : ${dealId}`);
    e2e.saveDealTestMap(1, `Test Case Number : FWD_06_C12499 and Deal ID : ${dealId}`);
    e2e.saveDealIdWithTest(`${dealId}@@complete:new:leg1`, `FWD_06_C12499@@FWD=>fwd=>dealt_ccy:FWD_USD_SGD_1M_${instrument.VENUE_B}_NEW`);
