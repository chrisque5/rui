...
describe('E2E scenario for Forward', () => {
  it('C18592 FWD_01_Turn_Trade FWD USD HKD ON XOFF (New)', () => {
    ...
    log.log(`Test Case Number : FWD_01_Turn_Trade and Deal ID : ${dealId}`);
    e2e.saveDealTestMap(1, `Test Case Number : FWD_01_Turn_Trade and Deal ID : ${dealId}`);
    sharedStore.setValueToStore('C18592', dealId);
    e2e.saveDealIdWithTest(`${dealId}@@complete:new:leg1`, `FWD_01_Turn_Trade@@FWD=>fwd=>turntrade:FWD_USD_HKD_ON_${instrument.VENUE_B}_NEW`);
