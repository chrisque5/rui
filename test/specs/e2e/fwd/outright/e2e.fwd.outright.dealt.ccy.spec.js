...
describe('E2E scenario for Forward Outright', () => {
  it('FWDOR_03_C12518 FWD SGD USD 1M XOFF (New)', () => {
    ...
    log.log(`Test Case Number : FWDOR_03_C12518 and Deal ID : ${dealId}`);
    e2e.saveDealTestMap(1, `Test Case Number : FWDOR_03_C12518 and Deal ID : ${dealId}`);
    e2e.saveDealIdWithTest(`${dealId}@@complete:new:leg1`, `FWDOR_03_C12518@@FWD=>fwd_outright=>dealt_ccy:FWD_SGD_USD_1M_${instrument.VENUE_B}_NEW`);
