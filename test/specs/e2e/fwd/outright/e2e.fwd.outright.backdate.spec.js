...
describe('E2E scenario for FWD Forward backdate ', () => {
  it('FWDOR_C13107 FWD USD CNH 2M TEMM (New)', () => {
    ...
    deal.placeOutrightOrder(instrument.CURRENCY_A, instrument.CURRENCY_S, '', instrument.TENOR_E1, '6.998054', '15');
    ...
    log.log(`Test Case Number : FWDOR_C13107 and Deal ID : ${dealId}`);
    e2e.saveDealTestMap(1, `Test Case Number : FWDOR_C13107 and Deal ID : ${dealId}`);
    sharedStore.setValueToStore('C13107', dealId);
    e2e.saveDealIdWithTest(`${dealId}@@complete:new:leg1`, `FWDOR_C13107@@FWD=>fwd_outright=>backdate:FWD_USD_CNH_2M_${instrument.VENUE_G}_NEW`);
