...
describe('E2E scenario for FWD Forward backdate ', () => {
  it('FWD_FWD_C13106 FWD USD CNH 1M*2M TEFD (New)', () => {
    ...
    deal.placeFwdForwardOrderDetails(instrument.CURRENCY_A, instrument.CURRENCY_S, '', instrument.TENOR_E, '6.9908', '56.54', '15', instrument.TENOR_E1, '', '15');
    ...
    log.log(`Test Case Number : FWD_FWD_C13106 and Deal ID : ${dealId}`);
    e2e.saveDealTestMap(1, `Test Case Number : FWD_FWD_C13106 and Deal ID : ${dealId}`);
    sharedStore.setValueToStore('C13106', dealId);
    e2e.saveDealIdWithTest(`${dealId}@@complete:new:leg1`, `FWD_FWD_C13106@@FWD=>fwd_fwd=>backdate:FWD_USD_CNH_1M_2M_${instrument.VENUE_E}_NEW`);
