const UserDetails = Object.create({
  ...
  CLIENT_B: { Client: 'BANK OF AMERICA NA (DBU), SIN', Location: '(SIN)', GCD: 143161, Reuters_Code: 'BOAS', LEI_Code: 'NA'  },
  CLIENT_C: { Client: 'BARCLAYS BANK PLC, SIN', Location: '(SIN)', GCD: 104054, Reuters_Code: 'BBIS', LEI_Code: 'G5GSEF7VJP5I7OUK5573'  },
  CLIENT_D: { Client: 'DEUTSCHE BANK AG, LON', Location: '(SIN)', GCD: 109056, Reuters_Code: 'BNPP', LEI_Code: 'NA'  },
  ...
  CLIENT_A_BLOTTER_LONGNAME: 'AMERICAN PRESIDENT BANK, SIN',
  CLIENT_B_BLOTTER: 'BK OF AMER NA DBU SIN',
  CLIENT_B_BLOTTER_LONGNAME: 'BANK OF AMERICA NA (DBU), SIN',
  ...
  TRADER_A_BLOTTER_LONGNAME: 'ABRAHAM LINCOLN',
  ...
  BROKER_D_BLOTTER: 'D. WONG',
  BROKER_D_BLOTTER_LONGNAME: 'DAVID WONG',
